...
class _BuyerOrderListPageState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(isVi ? 'Đơn đã mua' : 'My Orders', style: IndieFolkTheme.h1(isDark).copyWith(fontSize: 20)),
  ...
  Widget _itemPreview(List items, bool isDark, bool isVi) {
    ...
    return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(isVi ? 'Từ shop: $shopName' : 'From shop: $shopName',
            style: IndieFolkTheme.body(isDark).copyWith(fontSize: 11, color: IndieFolkTheme.secondary(isDark))),
        if (extra > 0)
  ...
  Widget _cancelBtn(
      Map<String, dynamic> o, bool isDark, bool isVi) {
